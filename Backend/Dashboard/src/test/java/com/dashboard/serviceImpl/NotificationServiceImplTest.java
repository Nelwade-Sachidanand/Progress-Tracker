...
class NotificationServiceImplTest {/*
									 ...
									 * 
									 * @Test void shouldCreateNotificationSuccessfully() {
									 * 
									 * ArgumentCaptor<Notification> captor =
									 * ArgumentCaptor.forClass(Notification.class);
									 * 
									 * notificationService.createNotification("Activity Updated",
									 * "Activity updated successfully", "ACTIVITY", "REF001", "/dashboard");
									 * 
									 ...
									 * 
									 * () -> assertEquals("Activity updated successfully",
									 ...
									 * 
									 * @Test void shouldThrowExceptionWhenRepositorySaveFails() {
									 * 
									 * doThrow(new
									 * RuntimeException("Database Error")).when(notificationRepository).save(any(
									 * Notification.class));
									 * 
									 * RuntimeException ex = assertThrows(RuntimeException.class, () ->
									 * notificationService.createNotification("Title", "Message", "TYPE", "REF001",
									 * "/dashboard"));
									 * 
									 * assertEquals("Database Error", ex.getMessage()); }
									 * 
									 * @Test void shouldSaveNotificationOnlyOnce() {
									 * 
									 * notificationService.createNotification("Title", "Message", "TYPE", "REF001",
									 * "/dashboard");
									 * 
