...
class UpdateActivityServiceImplTest {/*
										 ...
										 * 
										 * @Mock private ActivityUpdateRequestRepository requestRepository;
										 * 
										 ...
										 * 
										 * @InjectMocks private UpdateActivityServiceImpl updateActivityService;
										 * 
										 * @Test void shouldThrowProjectNotFoundException() {
										 * 
										 * ActivityModel request = new ActivityModel();
										 * 
										 * request.setProjectId("P001"); request.setProjectName("Progress Tracker");
										 * request.setPhaseName("Phase1"); request.setMilestoneName("Milestone1");
										 * request.setTaskName("Task1"); request.setSubTaskName("SubTask1");
										 ...
										 * 
										 * @Test void shouldThrowActivityNotFoundException() {
										 * 
										 ...
										 * request.setActivityName("Activity1");
										 * 
										 * Project project = new Project(); project.setProjectName("Progress Tracker");
										 * 
										 * Phase phase = new Phase(); phase.setPhaseName("Phase1");
										 * 
										 * Milestone milestone = new Milestone();
										 * milestone.setMilestoneName("Milestone1");
										 * 
										 * Task task = new Task(); task.setTaskName("Task1");
										 * 
										 * Subtask subtask = new Subtask(); subtask.setSubTaskName("SubTask1");
										 * 
										 * subtask.setActivities(new ArrayList<>());
										 * 
										 * task.setSubTasks(List.of(subtask)); milestone.setTasks(List.of(task));
										 * phase.setMilestones(List.of(milestone)); project.setPhases(List.of(phase));
										 * 
										 * when(context.getBean(ResponseBuilder.class)).thenReturn(responseBuilder);
										 * 
										 ...
										 * 
										 * @Test void shouldThrowNoChangesFoundException() {
										 * 
										 * ActivityModel request = new ActivityModel();
										 * 
										 * request.setProjectId("P001"); request.setProjectName("Progress Tracker");
										 ...
										 * request.setActivityName("Activity1");
										 * 
										 * request.setEstimatedPeriodWeek(2.0); request.setProgress(50);
										 * 
										 * Activity activity = new Activity();
										 * 
										 * activity.setActivityName("Activity1"); activity.setEstimatedPeriodWeek(2.0);
										 * activity.setProgress(50);
										 * 
										 * Subtask subtask = new Subtask();
										 * 
										 * subtask.setSubTaskName("SubTask1"); subtask.setActivities(List.of(activity));
										 * 
										 * Task task = new Task(); task.setTaskName("Task1");
										 * task.setSubTasks(List.of(subtask));
										 * 
										 * Milestone milestone = new Milestone();
										 * milestone.setMilestoneName("Milestone1"); milestone.setTasks(List.of(task));
										 * 
										 * Phase phase = new Phase(); phase.setPhaseName("Phase1");
										 * phase.setMilestones(List.of(milestone));
										 * 
										 * Project project = new Project(); project.setPhases(List.of(phase));
										 * 
										 * when(context.getBean(ResponseBuilder.class)).thenReturn(responseBuilder);
										 * 
										 * when(projectRepository.findById("P001")).thenReturn(Optional.of(project));
										 ...
										 * 
										 * @Test void shouldUpdateActivityRequestSuccessfully() {
										 * 
										 * SecurityContextHolder.getContext().setAuthentication(new
										 * UsernamePasswordAuthenticationToken("testUser", null));
										 * 
										 ...
										 * request.setActivityName("Activity1");
										 * 
										 * request.setEstimatedPeriodWeek(5.0); request.setProgress(80);
										 * 
										 * Activity activity = new Activity();
										 * 
										 * activity.setActivityName("Activity1"); activity.setEstimatedPeriodWeek(2.0);
										 ...
										 * 
										 * verify(notificationService, times(1)).createNotification(anyString(),
										 * anyString(), anyString(), any(), anyString());
										 * 
										 * verify(auditService, times(1)).saveAuditLog(any(), any(), anyString(),
										 * anyString(), any(), any(), anyString()); }
										 * 
										 * @Test void shouldThrowRequestAlreadyPendingException() {
										 * 
										 * ActivityModel request = new ActivityModel();
										 * 
										 * request.setProjectId("P001"); request.setProjectName("Progress Tracker");
										 ...
										 * Activity activity = new Activity();
										 * 
										 * activity.setActivityName("Activity1"); activity.setProgress(20);
										 * 
										 * Subtask subtask = new Subtask();
										 * 
										 * subtask.setSubTaskName("SubTask1"); subtask.setActivities(List.of(activity));
										 ...
										 * when(requestRepository
										 * .findByProjectIdAndPhaseNameAndMilestoneNameAndTaskNameAndSubTaskNameAndActivityNameAndStatus
										 * (any(), any(), any(), any(), any(), any(), eq("PENDING")))
										 ...
										 * 
										 * @Test void shouldHandleNullActivitiesList() {
										 * 
										 * ActivityModel request = new ActivityModel();
										 * 
										 * request.setProjectId("P001"); request.setProjectName("Progress Tracker");
										 ...
										 * }
										 * 
										 * @Test void shouldThrowValidationException_WhenProjectIdIsNull() {
										 * 
										 * ActivityModel request = new ActivityModel();
										 * 
										 ...
										 * updateActivityService.updateActivity(request)); }
										 * 
										 * @Test void shouldThrowDatabaseException_WhenSaveRequestFails() {
										 * 
										 * SecurityContextHolder.getContext() .setAuthentication( new
										 ...
										 * ActivityModel request = new ActivityModel();
										 * 
										 * request.setProjectId("P001"); request.setProjectName("Demo");
										 * request.setPhaseName("Phase1"); request.setMilestoneName("Milestone1");
										 * request.setTaskName("Task1"); request.setSubTaskName("SubTask1");
										 * request.setActivityName("Activity1");
										 * 
										 ...
										 * .thenReturn(Optional.empty());
										 * 
										 * doThrow(new RuntimeException("DB error")) .when(requestRepository)
										 * .save(any());
										 * 
										 ...
										 * 
										 * 
										 * @Test void shouldVerifyNotificationCreation() {
										 * 
										 * SecurityContextHolder.getContext() .setAuthentication( new
										 * UsernamePasswordAuthenticationToken( "admin", null));
										 * 
										 ...
										 * updateActivityService.updateActivity(request);
										 * 
										 * verify(notificationService) .createNotification( anyString(), anyString(),
